...
folder=categorical_4_latent_24
...
do
    python gumbel_softmax_vae.py --lr 5e-4 --temperature 1.5 --method reinmax --optim radam --categorical-dim 4 --latent-dim 24 --seed $SEED | tee ${folder}/reinmax_${SEED}.log
