...
folder=categorical_16_latent_12
...
do
    python gumbel_softmax_vae.py --lr 7e-4 --temperature 1.5 --method reinmax --optim radam --categorical-dim 16 --latent-dim 12 --seed $SEED | tee ${folder}/reinmax_${SEED}.log
