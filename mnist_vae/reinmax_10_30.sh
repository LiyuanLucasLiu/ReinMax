...
folder=categorical_10_latent_30
...
do
    python gumbel_softmax_vae.py --lr 5e-4 --temperature 1.3 --method reinmax --optim radam --categorical-dim 10 --latent-dim 30 --seed $SEED | tee ${folder}/reinmax_${SEED}.log
